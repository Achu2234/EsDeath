![Esdeath](https://telegra.ph/file/dfc0568a0ce5a9c14326c.jpg)
# EsDeath Robot 
...
### Read these notes carefully before proceeding 
 - Edit any mentions of @GeneralEsDeath_bot to your own support chat
...
`python3 -m Kurisu_makise_robot`

You can use [nssm](https://nssm.cc/usage) to install the bot as service on windows and set it to restart on /gitpull 
Make sure to edit the start and restart bats to your needs. 
Note: the restart bat requires that User account control be disabled.

For queries or any issues regarding the bot please open an issue ticket or visit us at [One Punch Support](https://t.me/kurisusupport)
## How to setup on Heroku 
For starters click on this button 

[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Achu2234/EsDeath) 
